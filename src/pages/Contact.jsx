                ...
                <div className="md:w-2/3 p-8">
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-4">
                      Have questions about our jewellery collection or custom designs? Fill out the form below and our team will get back to you within 24 hours.
                    </p>
                  </div>
                ...
                <div className="md:w-1/3 bg-gradient-to-b from-amber-600 to-amber-700 p-8 text-white md:flex md:flex-col md:justify-between">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-amber-100 text-sm">Shivdu Bomma center, Narasaraopet, Palnadu</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-amber-100 text-sm">Monday - Saturday:</p>
                          <p className="text-amber-100 text-sm">10:00 AM - 8:00 PM</p>
                  ...
                  <div className="mt-8 pt-6 border-t border-amber-500">
                    ...
                    <div className="flex space-x-4">
                      <a href="https://www.facebook.com/share/16YHTtohCM/?mibextid=wwXIfr" className="text-white hover:text-amber-200 transition-colors duration-200">
                        <span className="sr-only">Facebook</span>
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                        </svg>
                      </a>
                      <a href="https://www.instagram.com/siva_jewellerys?igsh=anJkc2UyNno2bTQx&utm_source=qr" className="text-white hover:text-amber-200 transition-colors duration-200">
                      ...
                      <a href="https://wa.me/+918977173601?text=%27Hii%27" className="text-white hover:text-amber-200 transition-colors duration-200">
